								...
								.click(
										function() {
											if (validation()) {
												...
												$("form")
														.attr('action',
																'${pageContext.request.contextPath }/board/writ')
														.submit()
											}
											function validation() {
												var contents = $
	...
	<form action="write" method="post" class="center" name="select_notice">
		...
		<table class="join-table">
			...
			<tr>
				...
				</select> <select id="title1" name="title" class="form-select">
						<option value="배송문의입니다!">배송문의입니다!</option>
						<option value="주문문의입니다!">주문문의입니다!</option>
						<option value="일반문의입니다!">일반문의입니다!</option>
				</select> <select id="title2" name="title" class="form-select"
					style="display: none;">
						<option value="후기입니다!">후기입니다!</option>
				</select> <select id="title3" name="title" class="form-select"
					style="display: none;">
						<option value="공지입니다!">공지입니다!</option>
				</select></td>
			</tr>
			<tr>
				<td colspan="2"><textarea id="editor" class="form-input"
