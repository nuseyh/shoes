	...
	<form action="upload" method="post" enctype="multipart/form-data">
		<table class="common-table center">
			<tr>
				<td>썸네일</td>
				<td>
					<input type="file" id="imgInp" name="file1" multiple /> 
					<input type="text" id="imgInp" name="savename1">
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<img id="blah" src="${pageContext.request.contextPath}/upload/${product.savename1}" alt="사진을 등록하십시오"> 
						<a href="${pageContext.request.contextPath}/upload/${product.savename1}"></a> --%>
					<img id = "blah" src="${ pageContext.request.contextPath}/file/${product.savename2 }" alt="${ pageContext.request.contextPath}/upload/${product.savename }"> 
			...
			<tr>
				<td>상세 이미지</td>
				<td>
					<input type="file" id="imgInp" name="file2" multiple />
			 		<input type="text" id="imgInp" name="savename2">
				</td>
			</tr>
			<tr>
				<td colspan="2"><img id="blah" src="${pageContext.request.contextPath}/upload/${product.savename2}"
					alt="사진을 등록하십시오"> 
				</td>
			</tr>
			<tr>
