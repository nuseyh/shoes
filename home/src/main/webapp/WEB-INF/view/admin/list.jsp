         ...
         <c:forEach var="product" items="${plist}">
            <tr id="move">
               ...
               <td><a href="itemedit?no=${product.i_num}"><img id="cb"
                  src="${pageContext.request.contextPath}/file/${product.savename1}">
               </a></td>
               <td><a href="itemedit?no=${product.i_num}">${product.i_name}</a></td>
               <td><a href="itemedit?no=${product.i_num}">${product.i_price }</a></td>
               <td><a href="itemedit?no=${product.i_num}">${product.i_detail}</a></td>
               <td><a href="itemedit?no=${product.i_num}">${product.i_type}</a></td>
            </tr>
         </c:forEach>
      </table>
