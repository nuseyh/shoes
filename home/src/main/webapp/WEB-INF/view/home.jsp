		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<img src="${pageContext.request.contextPath}/img/shoes.jpg" width="100%" height="100%">
				</div>
				<div class="swiper-slide">
					<img src="${pageContext.request.contextPath}/img/shoes2.jpg" width="100%" height="100%">
				</div>
