...
public class CartController {
	...
	public String cart_list(@RequestParam("user_id") String user_id, HttpServletRequest request) {
...
//		request.setAttribute("map", map);
	...
	public String cart_add(HttpServletRequest request) {
		...
		request.setAttribute("user_id", cart.getUser_id());
		System.out.println(cart.getUser_id());
		
		return "redirect:cart_list?user_id="+cart.getUser_id();
	}
