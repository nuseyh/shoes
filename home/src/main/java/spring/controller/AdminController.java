...
public class AdminController {
   ...
   public String mkdir() {
      File f = new File("C:\\Users\\IT202-28\\git\\shoes\\home\\src\\main\\webapp\\resource\\img\\i_name");
      if(!f.exists()) {
         f.mkdirs();
...
//      File target = new File(path, i_name);
   ...
   public String removeitems(HttpServletRequest request, Model model) {
    ...
    public String itemedit(@RequestParam("no") int no, HttpServletRequest request) {
...
//    public String itemedit2(Model model, Product p) {
//       model.addAttribute("product", adminDao.itemedit(no));
