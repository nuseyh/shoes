...
public class Cart {
   ...
   public Cart(int cart_no, String user_id, int product_no, String product_name, int product_price, int product_size,
         String product_color, int count, int amount) {
      super();
   }
   ...
   public String toString() {
      return "Cart [cart_no=" + cart_no + ", user_id=" + user_id + ", product_no=" + product_no + ", product_name="
            + product_name + ", product_price=" + product_price + ", product_size=" + product_size
            + ", product_color=" + product_color + ", count=" + count + ", amount=" + amount + "]";
   }
